...
/**
 * An Akka Extension to provide access to Spring managed Actor Beans. source: https://github.com/typesafehub/activator-akka-java-spring
 */
public class SpringExtension extends AbstractExtensionId<SpringExtension.SpringExt> {
	...
	/**
	 * The lookup method is required by ExtensionIdProvider, so we return ourselves here, this allows us to configure our extension to be
	 * loaded when the ActorSystem starts up
	 * 
	...
	public static class SpringExt implements Extension {
		 ...
		 * Create a Props for the specified actorBeanName using the SpringActorProducer class.
		 * 
		 * @param requiredType Type of the actor bean must match. Can be an interface or superclass of the actual class, or {@code null} for
		 *            any match. For example, if the value is {@code Object.class}, this method will succeed whatever the class of the
		 *            returned instance.
