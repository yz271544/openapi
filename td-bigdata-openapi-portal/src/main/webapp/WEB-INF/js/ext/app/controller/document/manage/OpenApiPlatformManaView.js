Ext.define('OpenApi.controller.document.manage.OpenApiPlatformManaView', {
	extend : 'Ext.app.Controller',
	
	id : 'openapiplatformctrl',
	views : [],
	refs : [{
		ref : 'op',
	...
	viewAdd : function(view, component, index, eOpts) {
		component.getComponent("opBody").addListener("add", function(opBody, component, index, eOpts) {
			if(component.getItemId() == "oapm_dtg") {
...
//					console.log(delRecord);
					Ext.Ajax.request({
					    url: (projRoot + '/documentPublish/modifyDirStruct.json'),
					    params : {
...
//	        		        		console.log(curNode.data.depth);
	        						var pos = 0;
