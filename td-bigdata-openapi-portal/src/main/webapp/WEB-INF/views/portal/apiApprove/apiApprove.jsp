...
<title>API审批管理</title>
<script src="${ctx}/js/modules/apiApprove/apiApprove.js"></script>
...
<body class="page-container-bg-solid page-boxed">
		...
		<div class="tab-pane" id="tab_2">
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-settings"></i>API审批管理
					</div>
					<div class="tools">
	...
	<div id="modal_apiApprove" class="modal fade" aria-hidden="false">
		<div class="modal-dialog modal-full">
			<div class="modal-content" id="modal_content_apiApprove">
				<input type="hidden" id="txt_apiId_tmp_new">
				<input type="hidden" id="txt_apiVersion_tmp_new">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true"></button>
					<div class="row modal-title font-green" id="">
						<h4>
							<i class="icon-settings"></i>&nbsp;&nbsp;API审批<span
								id="modal_apiApproveTitle"></span>
						</h4>
					</div>
				</div>
				<div class="modal-body" style="min-height:410px;">
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<span class="caption-subject">沙箱测试</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse" title="折叠"> </a>
							</div>
						...
						<div class="portlet-body">
							<div class="table-scrollable">
								<table class="table table-bordered" id="tb_apiApprove">
									<thead>
										<tr class="uppercase">
											<th class="text-center">#</th>
											<th  class="text-center" width="40%;">请求URL</th>
											<th class="text-center">提交方式</th>
											<th class="text-center">返回类型</th>
											<th class="text-center" width="40%;">返回结果</th>
					...
					<div class="portlet box green">
						...
						<div class="portlet-body">
							<form role="form" id="form_apiApprove">
								<div class="form-body">
									<div class="form-group">
									<label>审批意见:<span
								...
								<div class="row text-center">
									<button id='btn_apiApproveYes' type="button" class="btn green"
										title="审批通过">审批通过</button>
									<button id='btn_apiApproveNo' type="button"
