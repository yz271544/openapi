														...
														<div class="row">
															<div class="col-md-12">
																<div class="form-group">
																	...
																	&nbsp;查看参数介绍；<font color="red">*</font> 表示必填，<font color="blue">*</font> 表示几个参数中必填一个;
														...
														<div class="form-actions">
															<div class="row">
		                                                        <div class="col-md-offset-3 col-md-9">
		                                                            <input type="button" id="test_count_btn" class="btn grey-salsa btn-outline" readonly value="测试成功0次"/>
		                                                            <input type="button" id="commit_btn" class="btn green" value="提交测试（Execute）"/>
		                                                            <input type="button" id="publish_btn" class="btn green" value="发&nbsp;布" />
		                                                        </div>
		                                                    </div>
															
														</div>
													</div>
													<input type="hidden" id="test_count" value="0"/>
												</form>
												<!-- END FORM-->
											</div>
														...
														<div class="row">
															<div class="col-md-11">
																<div class="form-group">
																	...
																	<textarea style="resize:vertical" class="form-control" id="req_url" rows="10"></textarea>
																</div>
															</div>
														</div>
														<!--/row-->
