...
<html>
    ...
    <head>
        ...
        <script src="${ctx}/js/scripts/form-wizard.js" type="text/javascript"></script>
        ...
        <script src="${ctx}/js/scripts/admin/apiDeveloper.js" type="text/javascript"></script>
        <title>API开发者注册页面</title>
    </head>
    <!-- END HEAD -->
    <body>
                                    ...
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class=" icon-layers font-red"></i>
                                                <span class="caption-subject font-red bold uppercase"> API开发者者账号注册 -
                                                ...
                                                <div class="form-body">
                                                        ...
                                                        <li>
                                                            <a href="#tab2" data-toggle="tab" class="step">
                                                                <span class="number"> 2 </span>
                                                                    <span class="desc">
                                                                        <i class="fa fa-check"></i> 填写账号信息 </span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control" name="realUserName" id="realUserName"/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select name="orgCode" id="orgCode" class="form-control">
                                                                    <option value=""></option>
                                                                    <option value="01">山西移动</option>
                                                                    <option value="02">Teradata</option>
                                                                    <option value="03">思特奇</option>
                                                                    <option value="04">创我</option>
                                                                    <option value="05">浪潮</option>
                                                                </select>
                                                                <span class="help-block"> 请输入所属机构 </span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="radio-list">
                                                                    <label class="radio-inline">
                                                                        <input type="radio" name="userGender" id="userGender1" value="0" checked> 男 </label>
                                                                    <label class="radio-inline">
                                                                        <input type="radio" name="userGender" id="userGender2" value="1"> 女 </label>
                                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <span class="help-block"> 请输邮箱 </span>
                                                            </div>
                                                        </div>
                                                    </div>
