...
/**
 * Parser for openapi-submit command line options.
 * <p>
 * This class encapsulates the parsing code for openapi-submit command line options, so that there
 * is a single list of options that needs to be maintained (well, sort of, but it makes it harder
 * to break things).
 */
class OpenapiSubmitOptionParser {
  ...
  // OpenapiSubmitArguments.scala. That is also why this class is not abstract - to allow code to
  ...
  /**
   * This is the canonical list of openapi-submit options. Each entry in the array contains the
  ...
  /**
   * List of switches (command line options that do not take parameters) recognized by openapi-submit.
   */
  ...
  /**
   * Parse a list of openapi-submit command line options.
   * <p>
   * See OpenapiSubmitArguments.scala for a more formal description of available options.
   *
