...
class CommandBuilderUtils {
  ...
  static final String DEFAULT_PROPERTIES_FILE = "openapi-defaults.conf";
  static final String ENV_OPENAPI_HOME = "OPENAPI_HOME";
  static final String ENV_OPENAPI_ASSEMBLY = "_OPENAPI_ASSEMBLY";
  ...
  /**
   * Adds the default perm gen size option for Openapi if the VM requires it and the user hasn't
   * set it.
   */
