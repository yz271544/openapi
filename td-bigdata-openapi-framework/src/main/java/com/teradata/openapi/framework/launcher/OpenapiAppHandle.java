...
/**
 * A handle to a running Openapi application.
 * <p>
 * Provides runtime information about the underlying Openapi application, and actions to control it.
 *
 * @since 1.6.0
 */
public interface OpenapiAppHandle {
  ...
  public interface Listener {
     ...
     * @see OpenapiAppHandle#getState()
     */
    void stateChanged(OpenapiAppHandle handle);
     ...
     * @param handle The updated handle.
     */
    void infoChanged(OpenapiAppHandle handle);
