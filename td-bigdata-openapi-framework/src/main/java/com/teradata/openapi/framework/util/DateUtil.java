...
public class DateUtil {
	...
	public static Date getDateFirstSecond(Date date) throws ParseException {
		String sday = format(getDateAfterDays(date, 1), PATTERN_YYYY_MM_DD);
	 ...
	 * @author
	 */
	public static Date getLastDateLastSecond(Date date) throws ParseException {
		String sday = format(getDateAfterDays(date, -1), PATTERN_YYYY_MM_DD);
		return parse(sday + " 23:59:59", PATTERN_YYYY_MM_DD_HH_MM_SS);
	}
	...
	public static String DateFormatStrEn(Date Date, String format) throws ParseException {
	 ...
	 */
	public static String getLate1MonDate(String billCycle) throws ParseException {
	...
	public static String getLate2MonDate(String billCycle, String _PATTERN) throws ParseException {
		...
		String date = DateUtil.DateFormatStrEn(c.getTime(), _PATTERN);
		return date;
	}
